...
test('distributed companions expose a usable local contract, catalog and schema', async () => {
  ...
  try {
    ...
    for (const file of ['catalog.md', 'tdd.md', 'doubles-data.md', 'typescript.md', 'transpose-vitest.md', 'transpose-codeception.md', 'transpose-karma-jasmine-angular.md', 'record.md']) {
