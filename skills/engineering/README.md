...
- **[transpose-design-pattern](./transpose-design-pattern/SKILL.md)** — Select a pattern from the catalog and transpose it to Angular / React / Vue / Vanilla TS / Quarkus / PHP (Symfony) before implementation.
